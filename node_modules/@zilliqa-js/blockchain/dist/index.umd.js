(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@zilliqa-js/core'), require('@zilliqa-js/crypto'), require('@zilliqa-js/util'), require('@zilliqa-js/account')) :
    typeof define === 'function' && define.amd ? define(['exports', '@zilliqa-js/core', '@zilliqa-js/crypto', '@zilliqa-js/util', '@zilliqa-js/account'], factory) :
    (factory((global.zjsBlockchain = {}),global['@zilliqa-js/core'],global['@zilliqa-js/crypto'],global['@zilliqa-js/util'],global['@zilliqa-js/account']));
}(this, (function (exports,core,crypto,util,account) { 'use strict';
    ...
    function toTxParams(response) {
        ...
        var msg = receipt.errors
            ? Object.keys(receipt.errors).reduce(function (acc, depth) {
                var _a;
                var errorMsgList = receipt.errors[depth].map(function (num) { return core.TransactionError[num]; });
                return __assign(__assign({}, acc), (_a = {}, _a[depth] = errorMsgList, _a));
            }, {})
            : {};
        return __assign(__assign({}, rest), { version: parseInt(version, 10), toAddr: crypto.toChecksumAddress(toAddr), pubKey: senderPubKey.replace('0x', ''), gasPrice: new util.BN(gasPrice), gasLimit: util.Long.fromString(gasLimit, 10), amount: new util.BN(amount), nonce: parseInt(nonce, 10), code: code,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.provider.send(core.RPCMethod.CreateTransaction, __assign(__assign({}, tx.txParams), { priority: tx.toDS }))];
                        case 1:
                            response = _a.sent();
                            if (response.error) {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.provider.sendBatch(core.RPCMethod.CreateTransaction, txParamsList)];
                        case 1:
                            response = _f.sent();
                            if (response.error) {
                                throw response.error;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.provider.send(core.RPCMethod.CreateTransaction, tx)];
                        case 1:
                            response = _a.sent();
                            if (response.error) {
                                throw response.error;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.provider.send(core.RPCMethod.GetTransaction, txHash)];
                        case 1:
                            response = _a.sent();
                            if (response.error) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.provider.send(core.RPCMethod.GetTransactionStatus, txHash)];
                        case 1:
                            response = _a.sent();
                            if (response.error) {
                                return [2 /*return*/, Promise.reject(response.error)];
