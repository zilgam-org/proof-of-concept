...
(function (module, exports) {
  ...
  BN$$1.isBN = function isBN (num) {
    ...
    return num !== null && typeof num === 'object' &&
      num.constructor.wordSize === BN$$1.wordSize && Array.isArray(num.words);
  };
  ...
  BN$$1.prototype.strip = function strip () {
  ...
  BN$$1.prototype.inspect = function inspect () {
  ...
  */
  ...
  BN$$1.prototype.toBuffer = function toBuffer (endian, length) {
  ...
  if (Math.clz32) {
    BN$$1.prototype._countBits = function _countBits (w) {
  ...
  BN$$1.prototype.divmod = function divmod (num, mode, positive) {
    ...
    if (num.length === 1) {
      ...
      if (mode === 'mod') {
        return {
          div: null,
          mod: new BN$$1(this.modn(num.words[0]))
        };
      }
  ...
  // Find `this` % `num`
  BN$$1.prototype.mod = function mod (num) {
  ...
  Red.prototype.sqrt = function sqrt (a) {
    ...
    while (t.cmp(one) !== 0) {
      ...
      assert(i < m);
      var b = this.pow(c, new BN$$1(1).iushln(m - i - 1));
