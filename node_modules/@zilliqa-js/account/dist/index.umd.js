(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@zilliqa-js/core'), require('@zilliqa-js/util'), require('@zilliqa-js/proto'), require('@zilliqa-js/crypto'), require('bip39'), require('hdkey')) :
    typeof define === 'function' && define.amd ? define(['exports', '@zilliqa-js/core', '@zilliqa-js/util', '@zilliqa-js/proto', '@zilliqa-js/crypto', 'bip39', 'hdkey'], factory) :
    (factory((global.zjsAccount = {}),global['@zilliqa-js/core'],global['@zilliqa-js/util'],global['@zilliqa-js/proto'],global['@zilliqa-js/crypto'],global.bip39,global.hdkey));
}(this, (function (exports,core,util,proto,zcrypto,bip39,hdkey) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var formatOutgoingTx = function (req) {
        ...
        if (Array.isArray(req.payload) &&
            req.payload[0].method === core.RPCMethod.CreateTransaction &&
        ...
        if (!Array.isArray(req.payload) &&
            req.payload.method === core.RPCMethod.CreateTransaction &&
    ...
    var Transaction = /** @class */ (function () {
        function Transaction(params, provider, status, toDS, enableSecureToAddress) {
            if (status === void 0) { status = exports.TxStatus.Initialised; }
            ...
            this.toAddr = enableSecureToAddress
                ? zcrypto.normaliseAddress(params.toAddr)
                : zcrypto.toChecksumAddress(params.toAddr);
        ...
        Transaction.prototype.trackTx = function (txHash) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.provider.send(core.RPCMethod.GetTransaction, txHash)];
                        case 1:
                            res = _a.sent();
                            if (res.error) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.provider.send(core.RPCMethod.GetLatestTxBlock)];
                        case 1:
                            res = _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.provider.send(core.RPCMethod.GetBalance, addr.replace('0x', '').toLowerCase())];
                        case 1:
                            response = _a.sent();
                            if (response.error) {
